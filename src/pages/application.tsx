        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="flex flex-col w-full mt-10">
            <div className="flex items-center justify-start mb-4">
              <h2 className="!text-6xl !leading-tight !tracking-tight text-left" style={{ fontFamily: PRIMARY_FONT_FAMILY }}>Quant</h2>
              <span className="ml-4 text-6xl">&rarr;</span>
            </div>
            <div className="flex items-center justify-start mb-4">
              <h2 className="!text-6xl !leading-tight !tracking-tight text-left" style={{ fontFamily: PRIMARY_FONT_FAMILY }}>Fundamental</h2>
              <span className="ml-4 text-6xl">&rarr;</span>
            </div>
          </div>
          <div className="w-full max-w-5xl flex flex-col md:flex-row items-stretch mt-12 gap-0">
            ...
            <div className="flex-1 !p-8 flex flex-col items-center justify-start">
              <h2 className="!text-5xl text-center underline underline-offset-4 !mb-8" style={{ fontFamily: PRIMARY_FONT_FAMILY }}>Fundamental</h2>
            ...
            <div className="flex-1 !p-8 flex flex-col items-center justify-start">
              <h2 className="!text-5xl text-center underline underline-offset-4 !mb-8" style={{ fontFamily: PRIMARY_FONT_FAMILY }}>Quantitative</h2>
              <p className="text-base text-gray-700 mb-8 text-center max-w-md">
                <span className="font-semibold">Click the following link to apply for this team:</span><br />
